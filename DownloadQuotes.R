...
#GetQuotes("GBPUSD", startDate=ISOdate(2018, 12, 10,0, 0, 0,  tz = "UTC"), endDate=ISOdate(2018, 12, 17, 0, 0, 0, tz = "UTC"))
GetQuotes <- function(symbol, startDate=ISOdate(2013, 1, 1, 0, 0, 0, tz = "UTC"), endDate=ISOdate(2014, 1, 1, 0, 0, 0, tz = "UTC"), periodicity="M1", type="Asks"){
